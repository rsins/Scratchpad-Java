...
public final class MyPicture implements ActionListener {
   ...
   /**
     ...
     */
    public MyPicture(MyPicture picture) {
        width  = picture.width();
   ...
   /**
    ...
    public MyPicture(Picture picture) {
        width  = picture.width();
        height = picture.height();
        image = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
        filename = width + "-by-" + height;
    ...
    // Reset the internal picture to the given object.
    public void reset(Picture picture) {
        width  = picture.width();
        height = picture.height();
        image = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
        filename = width + "-by-" + height;
   ...
   /**
    ...
    public boolean equals(Object other) {
        ...
        MyPicture that = (MyPicture) other;
   ...
   /**
    ...
    public static void main(String[] args) {
    	MyPicture picture = new MyPicture(args[0]);
